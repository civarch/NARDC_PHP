<?php echo form_open('user/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="EntryDate" value="<?php echo $this->input->post('EntryDate'); ?>" class="form-control" id="EntryDate" />
		</div>
	</div>
	<div class="form-group">
		<label for="ExitDate" class="col-md-4 control-label">ExitDate</label>
		<div class="col-md-8">
			<input type="text" name="ExitDate" value="<?php echo $this->input->post('ExitDate'); ?>" class="form-control" id="ExitDate" />
		</div>
	</div>
